...
namespace BusinessTechSolutionsWebSite.Controllers
{
    public class ContactUsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Address,CellPhoneNumber")] ContactUs contactUs)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Address,CellPhoneNumber")] ContactUs contactUs)
        {
            if (ModelState.IsValid)
            {
